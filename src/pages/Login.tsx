    ...
    <Box className="min-h-screen bg-white font-onest text-zinc-900 flex flex-col">
      ...
      <main className="flex-1 flex flex-col items-center justify-center p-6 w-full max-w-2xl mx-auto text-center gap-10">
        <motion.div
          ...
          className="w-full flex flex-col items-start text-left border-l border-blue-500 pl-6 py-2"
        >
          ...
          <Text className="font-unbounded font-bold text-xl md:text-3xl text-black mb-6 tracking-tight uppercase">
            GATEWAY: AUTHORIZE
          </Text>
